  ...
  (function($, window) {
    ...
    Tendina = (function() {
      ...
      Tendina.prototype._openSubmenu = function(el) {
        ...
        $(el).parent('li').addClass('selected').find(' > a').attr('title','선택됨');
        this._close($openMenus);
        this.$el.find('.selected').not($targetMenu.parents('li')).removeClass('selected').children('a').removeAttr('title');
      ...
      Tendina.prototype._closeSubmenu = function(el) {
        ...
        $(el).parent().removeClass('selected').children('a').removeAttr('title');
        this._close($targetMenu);
        $nestedMenus.removeClass('selected').children('a').removeAttr('title');
      ...
      Tendina.prototype._showSubmenus = function() {
        ...
        return this.$el.find('li').addClass('selected').find(' > a').attr('title','선택됨');
      };
      ...
      Tendina.prototype._openActiveMenu = function(element) {
        ...
        $activeMenu.parent().addClass('selected').find(' > a').attr('title','선택됨').focus();
        return $activeParents.parent().addClass('selected').find(' > a').attr('title','선택됨');
      };
      ...
      Tendina.prototype.destroy = function() {
        ...
        return this.$el.find('.selected').removeClass('selected').children('a').removeAttr('title');
      };
